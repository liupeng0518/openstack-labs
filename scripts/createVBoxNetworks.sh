...
# set the IP address to 192.168.56.0/24 and make sure that there is no DCHP server
#
vboxmanage hostonlyif ipconfig vboxnet0 --netmask 255.255.255.0 --ip 192.168.56.1
